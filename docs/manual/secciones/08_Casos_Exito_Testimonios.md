...
```mermaid
graph TD
    A[Pregunta de Negocio] --> B[Análisis en CMI]
    B --> C[Datos Zona Sur]
    B --> D[Datos Oficinas Actuales]

    C --> C1[Ticket Medio: €2,100<br/>DOM: 145 días]
    D --> D1[Capacidad Ociosa: 35%<br/>Captación débil: -15% vs. objetivo]

    C1 --> E{Comparativa}
    D1 --> E

    E --> F[Decisión: Opción B<br/>ROI proyectado +180%]
